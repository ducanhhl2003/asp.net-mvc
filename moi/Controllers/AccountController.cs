    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    /*var mdUser = UserManager.FindByEmail(model.UserName);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    /*SendMail.SendEmail(user.Email, "Comfirm your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>","");
                    return View("NotificationEmailConfirm");*/
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                moi.Common.Common.SendMail("ShopOnline", "Quên mật khẩu", "Bạn click vào <a href='" + callbackUrl + "' >link này</a> để reset mật khẩu.", model.Email);
